...
public class JotForm {
    ...
    /**
     * Add new email to specified form.
     * @param formID Form ID is the numbers you see on a form URL. You can get form IDs when you call /user/forms.
     * @param email New question properties like type and text.
     * @return Returns properties of new email.
     */
    public JSONObject createFormEmail(long formID, HashMap<String, String> email ) {
    	HashMap<String, String> params = new HashMap<String, String>();
    	
    	Set<String> keys = email.keySet();
    	
    	for(String key: keys) {
    		params.put("email[" + key + "]", email.get(key));
    	}
    	
        return executePostRequest("/form/" + formID + "/emails", params);
    }
    
    /**
     *  Add new emails to specified form.
     * @param formID Form ID is the numbers you see on a form URL. You can get form IDs when you call /user/forms.
     * @param emails New email properties like type and text.
     * @return Returns properties of new emails.
     */
    public JSONObject createFormEmails(long formID, JSONObject emails) {
        return executePutRequest("/form/" + formID + "/emails", emails);
    }

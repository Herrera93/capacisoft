/*//GEN-FIRST:event_buscarBtnActionPerformed
 * To change this template, choose Tools | Templates//GEN-LAST:event_buscarBtnActionPerformed
...
public class PnlProveedor extends javax.swing.JPanel implements Comunicador{
    ...
    private void proveedoresTblMouseClicked(java.awt.event.MouseEvent evt) {                                            
    ...
    private void externoRBtnMouseClicked(java.awt.event.MouseEvent evt) {                                         
        internoRBtn.setSelected(false);
    }                                        

    private void internoRBtnMouseClicked(java.awt.event.MouseEvent evt) {                                         
        externoRBtn.setSelected(false);
    }                                        

    private void primerNombreTFdFocusLost(java.awt.event.FocusEvent evt) {                                          
    ...
    private void apellidoPaternoTFdFocusLost(java.awt.event.FocusEvent evt) {                                             
    ...
    private void apellidoMaternoTFdFocusLost(java.awt.event.FocusEvent evt) {                                             
    ...
    private void informacionTBnMouseClicked(java.awt.event.MouseEvent evt) {                                            
        
    }                                           

    private void informacionTBnStateChanged(javax.swing.event.ChangeEvent evt) {                                            
    ...
    private void guardarLABtnActionPerformed(java.awt.event.ActionEvent evt) {                                             
        almacenando = true;
    ...
    private void buscarLABtnActionPerformed(java.awt.event.ActionEvent evt) {                                            
    ...
    private void cancelarLABtnActionPerformed(java.awt.event.ActionEvent evt) {                                              
        if (JOptionPane.showConfirmDialog(this, "La información que"
            + " esta modificando se perdera,¿Aun así desea cancelarla?",
            "Precaucion", JOptionPane.YES_NO_OPTION,
            JOptionPane.WARNING_MESSAGE) == 0) {
    ...
    private void devolverLABtnActionPerformed(java.awt.event.ActionEvent evt) {                                              
        informacionTBn.setEnabledAt(0, true);
        informacionTBn.setEnabledAt(1, false);
        informacionTBn.setSelectedIndex(0);
    }                                             

    private void primerNombreTFdFocusGained(java.awt.event.FocusEvent evt) {                                            
        primerNombreTFd.setBorder(BORDER_ORIGINAL);
        validNomLbl.setForeground(new Color(213, 216, 222));
    }                                           

    private void apellidoPaternoTFdFocusGained(java.awt.event.FocusEvent evt) {                                               
        apellidoPaternoTFd.setBorder(BORDER_ORIGINAL);
        validApePatLbl.setForeground(new Color(213, 216, 222));
    }                                              

    private void apellidoMaternoTFdFocusGained(java.awt.event.FocusEvent evt) {                                               
        apellidoMaternoTFd.setBorder(BORDER_ORIGINAL);
        validApeMatLbl.setForeground(new Color(213, 216, 222));
    }                                              

    private void telefonoTFdFocusGained(java.awt.event.FocusEvent evt) {                                        
        telefonoTFd.setBorder(BORDER_ORIGINAL);
        validTelefonoLbl.setForeground(new Color(213, 216, 222));
    }                                       

    private void correoTFdFocusGained(java.awt.event.FocusEvent evt) {                                      
        correoTFd.setBorder(BORDER_ORIGINAL);
        validCorreoLbl.setForeground(new Color(213, 216, 222));
    }                                     

    private void correoTFdFocusLost(java.awt.event.FocusEvent evt) {                                    
        Pattern p = Pattern.compile(".+@.+");
        Matcher m = p.matcher(correoTFd.getText());
    ...
    private void telefonoTFdFocusLost(java.awt.event.FocusEvent evt) {                                      

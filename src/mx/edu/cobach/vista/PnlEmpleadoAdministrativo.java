...
public class PnlEmpleadoAdministrativo extends javax.swing.JPanel implements
    ...
    public PnlEmpleadoAdministrativo() 
   {
    ...
    private void initComponents() {
        ...
        dominioLbl = new javax.swing.JLabel();
        ...
        cancelarABtn = new javax.swing.JButton();
        registroALbl = new javax.swing.JLabel();
        registroAMsjLbl = new javax.swing.JLabel();
        ...
        opcionPnlLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, opcionPnlLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(empleadosSPn, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        dominioLbl.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        dominioLbl.setText("@cobachbc.edu.mx");
                                    ...
                                    .addGroup(informacion1PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(informacion1PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            ...
                                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, informacion1PnlLayout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(dominioLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 139, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        informacion1PnlLayout.setVerticalGroup(
            ...
            .addGroup(informacion1PnlLayout.createSequentialGroup()
                ...
                .addGroup(informacion1PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(dominioLbl, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(validCorreoLbl)
        ...
        cancelarABtn.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cancelarABtn.setText("Cancelar");
        cancelarABtn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cancelarABtnActionPerformed(evt);
            }
        });

        registroALbl.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        registroALbl.setText("Registro");

        registroAMsjLbl.setText("<html>Ingrese la información a almacenar, para salir o cancelar el registro presione el botón \"Cancelar\"</html>");
        ...
        informacion2PnlLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, informacion2PnlLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(cancelarABtn, javax.swing.GroupLayout.PREFERRED_SIZE, 108, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
            ...
            .addGroup(informacion2PnlLayout.createSequentialGroup()
                ...
                .addGroup(informacion2PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(registroAMsjLbl, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(registroALbl, javax.swing.GroupLayout.PREFERRED_SIZE, 200, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(informacion2PnlLayout.createSequentialGroup()
                        .addGroup(informacion2PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        informacion2PnlLayout.setVerticalGroup(
            ...
            .addGroup(informacion2PnlLayout.createSequentialGroup()
                ...
                .addGroup(informacion2PnlLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(cancelarABtn, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void empleadosTblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_empleadosTblMouseClicked
        ...
        int row = empleadosTbl.rowAtPoint(evt.getPoint());
        int col = empleadosTbl.columnAtPoint(evt.getPoint());
        if (col == 0) {
     ...
     * @param evt
     */
    private void cancelarABtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cancelarABtnActionPerformed
        //Se limpian los campos
        if (JOptionPane.showConfirmDialog(this, "La información que"
            + " esta modificando se perdera,¿Aun así desea cancelarla?",
            "Precaucion", JOptionPane.YES_NO_OPTION,
    ...
    }//GEN-LAST:event_cancelarABtnActionPerformed
    ...
    private javax.swing.JButton cancelarABtn;
    ...
    private javax.swing.JLabel dominioLbl;
    ...
    private javax.swing.JLabel registroALbl;
    private javax.swing.JLabel registroAMsjLbl;
    ...
    public void setTabla(String[][] info) {
        if(buscando){
            ...
            TableColumn tc = empleadosTbl.getColumnModel().getColumn(2);
            ...
            //Esconder columna ID
            empleadosTbl.getColumnModel().getColumn(1).setPreferredWidth(330);
        }
    }

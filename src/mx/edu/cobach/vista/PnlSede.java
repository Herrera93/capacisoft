package mx.edu.cobach.vista;//GEN-FIRST:event_buscarBtnActionPerformed
...
public class PnlSede extends javax.swing.JPanel implements Comunicador{
    ...
    private void sedesTblMouseClicked(java.awt.event.MouseEvent evt) {                                      
     ...
     * @param evt 
     */
    private void nombreTFdFocusLost(java.awt.event.FocusEvent evt) {                                    
        buscando = true;
        problema = false;
        control.buscarTodos();
    ...
    private void nombreTFdFocusGained(java.awt.event.FocusEvent evt) {                                      
        nombreTFd.setBorder(BORDER_ORIGINAL);
        validNomLbl.setForeground(new Color(213, 216, 222));
    }                                     

    private void capacidadTFdFocusGained(java.awt.event.FocusEvent evt) {                                         
        capacidadTFd.setBorder(BORDER_ORIGINAL);
        validCapacidadLbl.setForeground(new Color(213, 216, 222));
    }                                        

    private void capacidadTFdFocusLost(java.awt.event.FocusEvent evt) {                                       
    ...
    private void lugarTFdFocusGained(java.awt.event.FocusEvent evt) {                                     
        lugarTFd.setBorder(BORDER_ORIGINAL);
        validLugarLbl.setForeground(new Color(213, 216, 222));
    }                                    

    private void lugarTFdFocusLost(java.awt.event.FocusEvent evt) {                                   
    ...
    private void calleTFdFocusGained(java.awt.event.FocusEvent evt) {                                     
        calleTFd.setBorder(BORDER_ORIGINAL);
        validCalleLbl.setForeground(new Color(213, 216, 222));
    }                                    

    private void calleTFdFocusLost(java.awt.event.FocusEvent evt) {                                   
    ...
    private void coloniaTFdFocusGained(java.awt.event.FocusEvent evt) {                                       
        coloniaTFd.setBorder(BORDER_ORIGINAL);
        validColoniaLbl.setForeground(new Color(213, 216, 222));
    }                                      

    private void coloniaTFdFocusLost(java.awt.event.FocusEvent evt) {                                     
    ...
    private void numeroTFdFocusGained(java.awt.event.FocusEvent evt) {                                      
        numeroTFd.setBorder(BORDER_ORIGINAL);
        validNumeroLbl.setForeground(new Color(213, 216, 222));
    }                                     

    private void numeroTFdFocusLost(java.awt.event.FocusEvent evt) {                                    
    ...
    private void nombreTFdKeyTyped(java.awt.event.KeyEvent evt) {                                   
    ...
    private void capacidadTFdKeyTyped(java.awt.event.KeyEvent evt) {                                      
         char car = evt.getKeyChar();
    ...
    private void lugarTFdKeyTyped(java.awt.event.KeyEvent evt) {                                  
         char car = evt.getKeyChar();
        if (nombreTFd.getText().length() >= 45) {
            evt.consume();
        }
    ...
    private void calleTFdKeyTyped(java.awt.event.KeyEvent evt) {                                  
         char car = evt.getKeyChar();
        if (nombreTFd.getText().length() >= 45) {
            evt.consume();
        }
    ...
    private void coloniaTFdKeyTyped(java.awt.event.KeyEvent evt) {                                    
         char car = evt.getKeyChar();
        if (nombreTFd.getText().length() >= 45) {
            evt.consume();
        }

/*//GEN-FIRST:event_paginaActionPerformed
 * To change this template, choose Tools | Templates//GEN-LAST:event_paginaActionPerformed
...
//                    + "/Error/" + JOptionPane.ERROR_MESSAGE);
     ...
     */
    private void seleccionCBxActionPerformed(java.awt.event.ActionEvent evt) {                                             
        consultarAlerta();
    }                                            
     ...
     */
    private void periodoBtnActionPerformed(java.awt.event.ActionEvent evt) {                                           
        alerta1Pnl.setVisible(false);
        alerta2Pnl.setVisible(false);
        alerta3Pnl.setVisible(false);
        alerta4Pnl.setVisible(false);
     ...
     */
    private void eventoSpnStateChanged(javax.swing.event.ChangeEvent evt) {                                       
     ...
     */
    private void informacionSpnStateChanged(javax.swing.event.ChangeEvent evt) {                                            
     ...
     * encuesta pendiente.
     */
    private void encuestaSpnStateChanged(javax.swing.event.ChangeEvent evt) {                                         
     ...
     */
    private void resolverBtnActionPerformed(java.awt.event.ActionEvent evt) {                                            
     ...
     */
    private void paginaActionPerformed(java.awt.event.ActionEvent evt) {                                       
